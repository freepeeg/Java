 ...
 * @version 1.0
 */
public class XToggleButton<X extends XToggleButton, J extends JToggleButton> extends XAbstractButton<X, J> {
    /**
     * Creates an XToggleButton, replicating the specified component
     *
     * @param component the component to replicate
     */
    protected XToggleButton(J component) {
        super(component);
    }
