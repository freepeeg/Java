...
public class XButton<X extends XButton, B extends JButton> extends XAbstractButton<X, B> {
    /**
     * Creates an XButton, replicating the specified component
     *
     * @param component the component to replicate
     */
    protected XButton(B component) {
        super(component);
    }
     ...
     */
    public static XButton<XButton, JButton> create() {
        return new XButton<>(new JButton());
    }
     ...
     */
    public static XButton<XButton, JButton> create(Action a) {
        return new XButton<>(new JButton(a));
    }
     ...
     */
    public static XButton<XButton, JButton> create(Icon icon) {
        return new XButton<>(new JButton(icon));
    }
     ...
     */
    public static XButton<XButton, JButton> create(String text) {
        return new XButton<>(new JButton(text));
    }
     ...
     * @param icon the Icon image to display on the button
     */
    public static XButton<XButton, JButton> create(String text, Icon icon) {
        return new XButton<>(new JButton(text, icon));
    }
    ...
    public boolean isDefaultButton() {
        return component.isDefaultButton();
    }
    ...
    public boolean isDefaultCapable() {
        return component.isDefaultCapable();
    }
     ...
     */
    public X defaultCapable(boolean defaultCapable) {
        component.setDefaultCapable(defaultCapable);
        return (X) this;
    }
}
