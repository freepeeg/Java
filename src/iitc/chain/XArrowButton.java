 ...
 * @version 1.0
 */
public class XArrowButton<X extends XArrowButton, B extends BasicArrowButton> extends XButton<X, B> {
    /**
     * Creates an XArrowButton, replicating the specified component
     *
     * @param component the component to replicate
     */
    protected XArrowButton(B component) {
        super(component);
    }
     ...
     */
    public static XArrowButton<XArrowButton, BasicArrowButton> create(int direction) {
        return new XArrowButton<>(new BasicArrowButton(direction));
    }
     ...
     */
    public static XArrowButton<XArrowButton, BasicArrowButton> create(int direction, Color background, Color shadow, Color darkShadow, Color highlight) {
        return new XArrowButton<>(new BasicArrowButton(direction, background, shadow, darkShadow, highlight));
    }
    ...
    public X defaultCapable(boolean defaultCapable) {
        return super.defaultCapable(defaultCapable);
    }
}
