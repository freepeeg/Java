...
public abstract class XAbstractButton<X extends XAbstractButton, B extends AbstractButton> extends XComponent<X, B> {
    /**
     * Creates an XAbstractButton, replicating the specified component
     *
     * @param component the component to replicate
     */
    protected XAbstractButton(B component) {
        super(component);
    }
