...
public abstract class ReloadableFrame<B extends Manager, B2 extends Toolbar<B>> extends LoadableFrame {
    ...
    private final LoadablePanel<Component, B, B2, ReloadableFrame<B, B2>> instance;
    private B manager;
    private B2 toolbar;

    public ReloadableFrame(LoadablePanel<Component, B, B2, ReloadableFrame<B, B2>> instance) {
        this(null, instance);
    }

    public ReloadableFrame(String title, LoadablePanel<Component, B, B2, ReloadableFrame<B, B2>> instance) {
        super(title);
